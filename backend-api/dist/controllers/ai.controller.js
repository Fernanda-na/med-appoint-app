...
exports.recommendDoctors = recommendDoctors;
exports.chatbotQuery = chatbotQuery;
exports.analyzeFeedback = analyzeFeedback;
exports.automatedBooking = automatedBooking;
exports.sendNoShowReminder = sendNoShowReminder;
exports.confirmAppointmentReminder = confirmAppointmentReminder;
...
async function automatedBooking(req, res) {
    try {
        ...
        const doctors = await db_1.default.medecin.findMany({
            where: whereClause,
            include: {
                user: true,
                specialite: true,
...
async function sendNoShowReminder(req, res) {
    try {
...
async function confirmAppointmentReminder(req, res) {
    try {
        ...
        if (response.toLowerCase() === 'non') {
            ...
            await db_1.default.rendezVous.update({
                where: { id: appointmentId },
                data: { statut: 'ANNULE' }
            });
            return res.json({
